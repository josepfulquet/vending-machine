...
'use strict';
	...
	function getCurrent(){
		...
		let dataToSend          = {};
		dataToSend.method = "getcurrent";

		return axios.post(_options.baseHref, dataToSend);
	}
	
	function set(coin005, coin010, coin025){
		
		if (typeof coin005 === "undefined") throw new TypeError("no coin 005");
		if (typeof coin010 === "undefined") throw new TypeError("no coin 010");
		if (typeof coin025 === "undefined") throw new TypeError("no coin 025");
		
		let dataToSend          = {};
		dataToSend.method = "set";
		dataToSend.coin005 = coin005;
		dataToSend.coin010 = coin010;
		dataToSend.coin025 = coin025;
	...
	Change.prototype.get            = get;
	Change.prototype.getCurrent     = getCurrent;
	Change.prototype.set			= set;
