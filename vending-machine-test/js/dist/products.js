...
'use strict';
	...
	let _fileName			= "products.js";
	let _version			= "1.0.0";
	let _options			= null;
	let _self				= null; //for events
    ...
    function Products(options){
		...
		if (typeof options.baseHref === 'undefined') throw new TypeError('baseHref error');
/*
		options.lang		= typeof options.lang !== 'undefined' ? options.lang : "en";
		options.ip			= typeof options.ip !== 'undefined' ? options.ip : "";
		options.userAgent	= typeof navigator !== 'undefined' ? navigator.userAgent : null;
		options.customer_id	= getCookie("st_customer_id");
		options.session_id	= getCookie("st_session_id");
	...
	function get(){
		...
		return axios.post(_options.baseHref, dataToSend);
		
	}
	
	function set(water, juice, soda){
		
		if (typeof water === "undefined") throw new TypeError("no water");
		if (typeof juice === "undefined") throw new TypeError("no juice");
		if (typeof soda === "undefined") throw new TypeError("no soda");
		
		let dataToSend          = {};
		dataToSend.method = "set";
		dataToSend.water = water;
		dataToSend.juice = juice;
		dataToSend.soda = soda;
	...
	Products.prototype.get          = get;
	Products.prototype.set          = set;
