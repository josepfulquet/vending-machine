...
'use strict';
	...
	function insertCoin(coin){
		...
		if (typeof coin === "undefined") throw new TypeError("no coin");

		let dataToSend          = {};
		dataToSend.method = "insertcoin";
		dataToSend.coin = coin;
	...
	function buy(item){
		...
		if (typeof item === "undefined") throw new TypeError("no item");

		let dataToSend          = {};
		dataToSend.method = "buy";
		dataToSend.item = item;
    ...
    window.Vending                  = Vending;
	Vending.prototype.insertCoin    = insertCoin;
	Vending.prototype.returnCoins   = returnCoins;
	Vending.prototype.buy           = buy;
